...
When the CloudPilot AI Agent starts, it automatically detects the Prometheus Endpoint in your cluster.
If the Prometheus Endpoint is not automatically populated on the page, you can restart the agent to trigger the detection process.
