...
This document outlines the design and implementation of a solution for reducing pod disruption in Karpenter by diversifying instance types across workloads in your cluster. By configuring workloads to include the `workload.cloudpilot.ai/diversity-instancetype=true` label, you can reduce the probability of simultaneous interruptions by ensuring that your workloads are spread across different instance types.
