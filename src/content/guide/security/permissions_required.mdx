...
rules:
  ...
  - apiGroups:
    ...
    verbs:
      ...
      - list
      - watch
  - apiGroups: ["autoscaling.cloudpilot.ai"]
    resources:
      - enhancedverticalpodautoscalerconfigurations
      - enhancedverticalpodautoscalerconfigurations/status
    verbs: [create, update, list, watch, patch, delete]
  - apiGroups: ["autoscaling.cloudpilot.ai"]
    resources:
      - enhancedverticalpodautoscalers
      - enhancedverticalpodautoscalers/status
